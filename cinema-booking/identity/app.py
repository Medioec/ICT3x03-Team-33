...
def register():
    ...
    response = requests.post("https://databaseservice/databaseservice/user/add_user", json=data)
...
def login():
    ...
    response = requests.post("https://databaseservice/databaseservice/usersessions/get_userId_hash_role", json=requestData)
    ...
    response = requests.post("https://databaseservice/databaseservice/usersessions/store_key_in_database", json=requestData)
...
def logout():
    ...
    response = requests.put("https://databaseservice/databaseservice/usersessions/update_session_status_by_id", json=requestData)
...
def enhancedAuth():
    ...
    try:
        ...
        response = requests.post("https://databaseservice/databaseservice/usersessions/get_user_session", json=requestData)
